    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="flex items-center justify-between px-8 py-4 border-b border-gray-200">
        ...
        <nav className="hidden md:flex items-center gap-8 text-xs tracking-widest text-gray-600">
          <span className="cursor-pointer hover:text-gray-900">APPAREL</span>
          <span className="cursor-pointer hover:text-gray-900">HOUSEHOLD</span>
          <span className="cursor-pointer hover:text-gray-900">FOOD</span>
          <span className="cursor-pointer hover:text-gray-900">FURNITURE</span>
        </nav>
